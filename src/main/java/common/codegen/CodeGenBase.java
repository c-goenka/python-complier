...
import common.astnodes.BooleanLiteral;
import common.astnodes.ClassDef;
import common.astnodes.Declaration;
import common.astnodes.FuncDef;
import common.astnodes.GlobalDecl;
import common.astnodes.IntegerLiteral;
import common.astnodes.Literal;
import common.astnodes.NonLocalDecl;
import common.astnodes.Program;
import common.astnodes.Stmt;
import common.astnodes.TypedVar;
import common.astnodes.VarDef;
...
/**
 * The code generator for a PyLang program.
 *
...
public abstract class CodeGenBase {
    ...
    /**
     * Initializes a code generator for PyLang that uses BACKEND to emit
     * assembly code.
     *
    ...
    /**
     * Emits code outside the PyLang program.
     *
