...
public class SymbolTable<T> {
    ...
    private final HashMap<String, SymbolTable<T>> nested_syms = new HashMap<>();
    ...
    public void addNestedSym(String name, SymbolTable<T> sym) {
        nested_syms.put(name, sym);
    }

    public SymbolTable<T> getNestedSym(String name) {
        return nested_syms.get(name); // returns null if name not present
    }
